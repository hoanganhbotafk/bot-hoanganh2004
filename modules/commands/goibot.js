...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "Hoàng Anh") || (event.body.toLowerCase() == "Hoàng Anh")) {
  ...
  if ((event.body.toLowerCase() == "Hoàng Anh") || (event.body.toLowerCase() == "Hoàng Anhn ")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Hoàng Anhn") || (event.body.toLowerCase() == "Hoàng Anh")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://www.facebook.com/hoanganh2k4ninhso", threadID);
  };
  ...
  if ((event.body.toLowerCase() == " ibot") || (event.body.toLowerCase() == "yeu bot")) {
    return api.sendMessage("Hmm... Bot ngại lắm thôi yêu admin của bot và chị người yêu admin nhé :))", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Lý Bá Hoàng Anh có gì dùng lệnh !ad hoặc !adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "Hoàng Anh") || (event.body.toLowerCase() == "og Dang")) {
